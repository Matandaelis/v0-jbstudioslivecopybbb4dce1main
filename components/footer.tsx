    ...
    <footer className="bg-gray-950 border-t border-gray-800 py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <a
                  href="https://earn.jessicabrown.co.ke"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://jessicabrowncollections.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-pink-400"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <a
                  href="https://earn.autowheels.co.ke"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <a
                  href="https://crm.jessicabrowncollections.com"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <a
                  href="https://logistics.jessicabrowncollections.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-green-400"
                >
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 mb-4">© 2025 JB Studios. All rights reserved.</p>

          {/* Social Media Icons */}
          <div className="flex justify-center gap-4 mb-6">
            <a
              href="https://instagram.com/jessicabrowncollections"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://tiktok.com/@jessicabrowncollections"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://youtube.com/@jessicabrowncollections"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://facebook.com/jessicabrowncollections"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://twitter.com/jessicabrownke"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-black flex items-center justify-center text-white hover:scale-110 transition-transform"
            >
